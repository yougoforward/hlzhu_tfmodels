...
python dual_pyramid_train_v3plusCam.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/train12"\
...
python dual_pyramid_eval_v3plusCam.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/train12"\
    --eval_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/eval12"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
