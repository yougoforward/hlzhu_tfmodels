...
python dual_pyramid_train_v3plusCam.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --tf_initial_checkpoint="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/train13/model.ckpt-60000"\
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/train_finetune13"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"
...
python dual_pyramid_eval_v3plusCam.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/train_finetune13"\
    --eval_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_res50_on_trainaug_set/eval_finetune13"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
    --max_number_of_evaluations=1
#    --eval_scales=0.5\
#    --eval_scales=0.75\
