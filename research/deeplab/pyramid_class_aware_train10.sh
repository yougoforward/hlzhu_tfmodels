...
python pyramid_class_aware_train10.py\
    ...
    --dataset="pascal_voc_seg"\
    --tf_initial_checkpoint="datasets/pascal_voc_seg/exp/pyramid_class_aware_train10_on_trainaug_set/train/model.ckpt-30000"\
    --train_logdir="datasets/pascal_voc_seg/exp/pyramid_class_aware_train10_on_trainaug_set/train_finetune"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"
...
python pyramid_class_aware_eval10.py\
    ...
    --eval_crop_size=513\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/pyramid_class_aware_train10_on_trainaug_set/train_finetune"\
    --eval_logdir="datasets/pascal_voc_seg/exp/pyramid_class_aware_train10_on_trainaug_set/eval_finetune"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
    --max_number_of_evaluations=1449
