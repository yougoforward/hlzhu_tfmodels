...
def get_class_aware_attention_branch_logits1(features,
  ...
  #   features3 = tf.multiply(features_aspp1, s2, name=None)
    ...
    attentioned_score = tf.multiply(submin, s1, name=None)
    addmin = tf.add(attentioned_score, smin, name=None)

    return [addmin,context_free_score_logits, context_sensitive_logits, features_aspp2]
...
def get_class_aware_attention_branch_logits(features,
  ...
  with slim.arg_scope(
    ...
    return [addmin,context_free_score_logits, context_sensitive_logits,f2]
