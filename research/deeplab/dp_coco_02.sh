...
#    --train_logdir="datasets/coco/exp/dpx65_cocovoc1000_train_set/train"\
...
#    --checkpoint_dir="datasets/coco/exp/dpx65_cocovoc1000_train_set/train" \
#    --eval_logdir="datasets/coco/exp/dpx65_cocovoc1000_val_set/eval" \
#    --dataset_dir="datasets/coco/tfrecord" \
...
#    --dataset_dir="datasets/pascal_voc_seg/tfrecord"#!/usr/bin/env bash