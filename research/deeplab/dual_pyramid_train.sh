...
python dual_pyramid_train.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_res50_on_trainaug_set/train"\
...
python dual_pyramid_eval.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/dual_pyramid_train_res50_on_trainaug_set/train"\
    --eval_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_res50_on_trainaug_set/eval"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
