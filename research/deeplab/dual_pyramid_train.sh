...
python dual_pyramid_train.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_skip3x3_res50_on_trainaug_set/train9"\
...
python dual_pyramid_eval.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/dual_pyramid_train_skip3x3_res50_on_trainaug_set/train9"\
    --eval_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_skip3x3_res50_on_trainaug_set/eval9"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
