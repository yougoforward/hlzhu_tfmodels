...
python dual_pyramid_train_fpn.py\
    ...
    --train_logdir="datasets/coco/exp/dpx65_cocovoc_train_set/train"\
...
python dual_pyramid_eval_fpn.py\
    ...
    --checkpoint_dir="datasets/coco/exp/dpx65_cocovoc_train_set/train"\
    --eval_logdir="datasets/coco/exp/dpx65_cocovoc_val_set/eval_cocovoc"\
    --dataset_dir="datasets/coco/tfrecord"\
