...
#    --train_logdir="datasets/cityscapes/exp/dpcan/train3"\
...
python3 dual_pyramid_train_fpn.py \
    ...
    --dataset="cityscapes"\
    --tf_initial_checkpoint="datasets/pascal_voc_seg/init_models/xception/model.ckpt"\
    --train_logdir="datasets/cityscapes/exp/dpcan/train4"\
    --dataset_dir="datasets/cityscapes/tfrecord"
...
python3 dual_pyramid_eval_fpn.py \
    ...
    --decoder_use_separable_conv=false\
    --dataset="cityscapes" \
    --checkpoint_dir="datasets/cityscapes/exp/dpcan/train4"\
    --eval_logdir="datasets/cityscapes/exp/dpcan/eval4"\
    --dataset_dir="datasets/cityscapes/tfrecord"\
...
python3 dual_pyramid_eval_fpn.py \
    ...
    --dataset="cityscapes" \
    --checkpoint_dir="datasets/cityscapes/exp/dpcan/train4"\
    --eval_logdir="datasets/cityscapes/exp/dpcan/eval4_os8"\
    --dataset_dir="datasets/cityscapes/tfrecord"\
    --max_number_of_evaluations=1
#    --eval_scales=0.5\
#    --eval_scales=0.75\
...
python3 dual_pyramid_eval_fpn.py \
    ...
    --dataset="cityscapes" \
    --checkpoint_dir="datasets/cityscapes/exp/dpcan/train4"\
    --eval_logdir="datasets/cityscapes/exp/dpcan/eval4_os8_175"\
    --dataset_dir="datasets/cityscapes/tfrecord"\
    --max_number_of_evaluations=1\
    --eval_scales=0.5\
    --eval_scales=0.75\
