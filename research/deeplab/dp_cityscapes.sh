...
python3 dual_pyramid_train_fpn.py \
    ...
    --train_logdir="datasets/cityscapes/exp/dpcan/train_finetune3"\
    --dataset_dir="datasets/cityscapes/tfrecord"
#
python3 dual_pyramid_eval_fpn.py \
    --logtostderr \
    ...
    --decoder_use_separable_conv=false\
    --dataset="cityscapes" \
    --checkpoint_dir="datasets/cityscapes/exp/dpcan/train_finetune3"\
    --eval_logdir="datasets/cityscapes/exp/dpcan/eval_finetune3"\
    --dataset_dir="datasets/cityscapes/tfrecord"\
    --max_number_of_iterations=1
#    --eval_scales=0.5\
#    --eval_scales=0.75\
...
#    --dataset_dir="datasets/cityscapes/tfrecord"#!/usr/bin/env bash