...
python class_aware_train15_nosigmoidsoftmax1loss.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --tf_initial_checkpoint="datasets/pascal_voc_seg/exp/class_aware_train15_add2_256256256_nosigmoidsoftmax1loss_res50_multigrad_on_trainaug_set/train/model.ckpt-60000"\
