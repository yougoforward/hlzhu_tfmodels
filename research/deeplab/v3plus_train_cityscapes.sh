...
python train.py \
    ...
    --train_logdir="datasets/cityscapes/exp/v3plus/train"\
...
#    --decoder_use_separable_conv=false\
#    --dataset="cityscapes" \
#    --checkpoint_dir="datasets/cityscapes/exp/v3plus/train"\
#    --eval_logdir="datasets/cityscapes/exp/v3plus/eval"\
#    --dataset_dir="datasets/cityscapes/tfrecord"\
...
python dual_pyramid_train_fpn.py \
    ...
    --decoder_use_separable_conv=false\
    --dataset="cityscapes"\
    --tf_initial_checkpoint="datasets/cityscapes/exp/v3plus/train/model.ckpt-90000"\
    --train_logdir="datasets/cityscapes/exp/v3plus/train_finetune"\
    --dataset_dir="datasets/cityscapes/tfrecord"
##
python dual_pyramid_eval_fpn.py \
    ...
    --decoder_use_separable_conv=false\
    --dataset="cityscapes" \
    --checkpoint_dir="datasets/cityscapes/exp/v3plus/train_finetune"\
    --eval_logdir="datasets/cityscapes/exp/v3plus/eval_finetune"\
    --dataset_dir="datasets/cityscapes/tfrecord"\
    --max_number_of_iterations=1
#    --eval_scales=0.75\
#    --eval_scales=1.0\
