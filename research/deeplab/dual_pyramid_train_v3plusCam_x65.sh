...
python dual_pyramid_train_v3plusCam.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_xception65_on_trainaug_set/train14"\
...
python dual_pyramid_eval_v3plusCam.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_xception65_on_trainaug_set/train14"\
    --eval_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_xception65_on_trainaug_set/eval14"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
...
python dual_pyramid_train_v3plusCam.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --tf_initial_checkpoint="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_xception65_on_trainaug_set/train14/model.ckpt-30000"\
    --train_logdir="datasets/pascal_voc_seg/exp/dual_pyramid_train_v3plusCam_xception65_on_trainaug_set/train_finetune14"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"
