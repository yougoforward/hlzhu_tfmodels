...
#    --train_logdir="datasets/coco/exp/dpx65_cocovoc_train_set/train_01"\
...
#    --checkpoint_dir="datasets/coco/exp/dpx65_cocovoc_train_set/train_01" \
#    --eval_logdir="datasets/coco/exp/dpx65_cocovoc_val_set/eval_cocovoc_01" \
#    --dataset_dir="datasets/coco/tfrecord" \
...
python dual_pyramid_train_fpn.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --tf_initial_checkpoint="datasets/coco/exp/dpx65_cocovoc_train_set/train/model.ckpt-225000"\
