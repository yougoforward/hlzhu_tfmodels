...
python class_aware_train8.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/class_aware_train8_on_trainaug_set/train"\
...
python class_aware_train8.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/class_aware_train8_on_trainaug_set/train_finetune"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"

python class_aware_eval8.py\
    --logtostderr\
    --eval_split="val"\
    --model_variant="xception_65"\
    --atrous_rates=6\
    ...
    --eval_crop_size=513\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/class_aware_train8_on_trainaug_set/train_finetune"\
    --eval_logdir="datasets/pascal_voc_seg/exp/class_aware_train8_on_trainaug_set/eval_finetune"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
    --max_number_of_evaluations=1449