...
python class_aware_train15_add2.py\
    ...
    --train_logdir="datasets/pascal_voc_seg/exp/class_aware_train15_add2_on_trainaug_set/train"\
...
python class_aware_eval15_add2.py\
    ...
    --decoder_use_separable_conv=false\
    --dataset="pascal_voc_seg"\
    --checkpoint_dir="datasets/pascal_voc_seg/exp/class_aware_train15_add2_on_trainaug_set/train"\
    --eval_logdir="datasets/pascal_voc_seg/exp/class_aware_train15_add2_on_trainaug_set/eval"\
    --dataset_dir="datasets/pascal_voc_seg/tfrecord"\
